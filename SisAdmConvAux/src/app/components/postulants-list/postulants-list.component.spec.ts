...
import { PostulantsListComponent } from "./postulants-list.component";
...
describe("PostulantsListComponent", () => {
  let postulantsListComponent: PostulantsListComponent;
  let fixture: ComponentFixture<PostulantsListComponent>;
  let router;
  let navigateSpy;
  let apiServiceMock;
  ...
  beforeEach(async(() => {
    ...
    TestBed.configureTestingModule({
      declarations: [PostulantsListComponent],
      imports: [BrowserModule, HttpClientTestingModule, RouterTestingModule],
      providers: [{ provide: ApiService, useValue: apiServiceMock }],
    })
      .compileComponents()
      .then(() => {
        fixture = TestBed.createComponent(PostulantsListComponent);
        postulantsListComponent = fixture.componentInstance;
  ...
  it("#constructor, should create a postulant list component", () => {
    expect(PostulantsListComponent).toBeTruthy();
  });

  it("#searchLogBooks, should get logbooks correctly", () => {});

  it("#searchLogBooks, should get logbooks incorrectly", () => {});

  it("#reviewRequirements, should move to the reviewRequirements view", () => {});
});
