...
import { EnabledPostulantsComponent } from "./enabled-postulants.component";
...
describe("EnabledPostulantsComponent", () => {
  let enabledPostulantsComponent: EnabledPostulantsComponent;
  let fixture: ComponentFixture<EnabledPostulantsComponent>;
  let router;
  let navigateSpy;
  let apiServiceMock;
  ...
  beforeEach(async(() => {
    ...
    TestBed.configureTestingModule({
      declarations: [EnabledPostulantsComponent],
      imports: [BrowserModule, HttpClientTestingModule, RouterTestingModule],
      providers: [{ provide: ApiService, useValue: apiServiceMock }],
    })
      .compileComponents()
      .then(() => {
        fixture = TestBed.createComponent(EnabledPostulantsComponent);
  ...
  it("#constructor, should create a postulant list component", () => {
    expect(EnabledPostulantsComponent).toBeTruthy();
  });
