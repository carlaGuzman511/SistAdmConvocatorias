...
import { NoEnabledPostulantsComponent } from "./no-enabled-postulants.component";
...
describe("NoEnabledPostulantsComponent", () => {
  let enabledPostulantsComponent: NoEnabledPostulantsComponent;
  let fixture: ComponentFixture<NoEnabledPostulantsComponent>;
  let router;
  let navigateSpy;
  let apiServiceMock;
  ...
  beforeEach(async(() => {
    ...
    TestBed.configureTestingModule({
      declarations: [NoEnabledPostulantsComponent],
      imports: [BrowserModule, HttpClientTestingModule, RouterTestingModule],
      providers: [{ provide: ApiService, useValue: apiServiceMock }],
    })
      .compileComponents()
      .then(() => {
        fixture = TestBed.createComponent(NoEnabledPostulantsComponent);
  ...
  it("#constructor, should create a postulant list component", () => {
    expect(NoEnabledPostulantsComponent).toBeTruthy();
  });
