...
@Component({
  selector: "app-register-commission-member",
  templateUrl: "./register-commission-member.component.html",
  styleUrls: ["./register-commission-member.component.css"],
})
/**
  This class contains the component register commission member
  @class RegisterCommissionMemberComponent
*/
export class RegisterCommissionMemberComponent implements OnInit {
  ...
  */
  ...
  /**
   This function searches the announcement
  ...
  private searchAnnouncement(): void {
    this.apiService.getById("announcement", this.idAnnouncement).subscribe(
      (response: Announcement) => {
        ...
        this.userForm.controls.area.setValue(this.announcement.area.idarea);
        this.searchShedule();
        this.searchCourts();
      },
      (error: HttpErrorResponse) => {
        this.showMessage.showError("Convocatoria no encontrada");
      }
    );
  }
  /**
