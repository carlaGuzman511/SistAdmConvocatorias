...
@Data
@Entity
@Table(name = "ResultFinalLaboratory")
public class ResultFinalLaboratory {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "native")
    @GenericGenerator(name = "native", strategy = "native")
    @Column(name="idresultfinallaboratory")
    private long idresultfinallaboratory;
    @Column
    ...
    @Column
    private double scoreLaboratory;
